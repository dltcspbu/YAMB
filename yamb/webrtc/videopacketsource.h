...
/// VideoPacketSource implements a simple `webrtc::VideoCaptureModule` that
...
/// video can be used as a `webrtc::VideoCaptureModule` and in that way a remote
/// video stream can implement the `MediaStreamSourceInterface`.
class VideoPacketSource : public webrtc::VideoCaptureModule
{
public:
    ...
    /// webrtc::VideoCaptureModule implementation.
...
//
//     virtual webrtc::VideoCaptureModule* Create(const cricket::Device& device) {
