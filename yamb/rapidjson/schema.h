...
public:
    ~ISchemaStateFactory() {}
    ISchemaValidator* CreateSchemaValidator(const SchemaType&) = 0;
    void DestroySchemaValidator(ISchemaValidator* validator) = 0;
    void* CreateHasher() = 0;
    uint64_t GetHashCode(void* hasher) = 0;
    void DestroryHasher(void* hasher) = 0;
    void* MallocState(size_t size) = 0;
    void FreeState(void* p) = 0;
};
...
public:
    ...
    void NotMultipleOf(int64_t actual, const SValue& expected) = 0;
    void NotMultipleOf(uint64_t actual, const SValue& expected) = 0;
    void NotMultipleOf(double actual, const SValue& expected) = 0;
    void AboveMaximum(int64_t actual, const SValue& expected, bool exclusive) = 0;
    void AboveMaximum(uint64_t actual, const SValue& expected, bool exclusive) = 0;
    void AboveMaximum(double actual, const SValue& expected, bool exclusive) = 0;
    void BelowMinimum(int64_t actual, const SValue& expected, bool exclusive) = 0;
    void BelowMinimum(uint64_t actual, const SValue& expected, bool exclusive) = 0;
    void BelowMinimum(double actual, const SValue& expected, bool exclusive) = 0;

    void TooLong(const Ch* str, SizeType length, SizeType expected) = 0;
    void TooShort(const Ch* str, SizeType length, SizeType expected) = 0;
    void DoesNotMatch(const Ch* str, SizeType length) = 0;

    void DisallowedItem(SizeType index) = 0;
    void TooFewItems(SizeType actualCount, SizeType expectedCount) = 0;
    void TooManyItems(SizeType actualCount, SizeType expectedCount) = 0;
    void DuplicateItems(SizeType index1, SizeType index2) = 0;

    void TooManyProperties(SizeType actualCount, SizeType expectedCount) = 0;
    void TooFewProperties(SizeType actualCount, SizeType expectedCount) = 0;
    void StartMissingProperties() = 0;
    void AddMissingProperty(const SValue& name) = 0;
    bool EndMissingProperties() = 0;
    void PropertyViolations(ISchemaValidator** subvalidators, SizeType count) = 0;
    void DisallowedProperty(const Ch* name, SizeType length) = 0;

    void StartDependencyErrors() = 0;
    void StartMissingDependentProperties() = 0;
    void AddMissingDependentProperty(const SValue& targetName) = 0;
    void EndMissingDependentProperties(const SValue& sourceName) = 0;
    void AddDependencySchemaError(const SValue& souceName, ISchemaValidator* subvalidator) = 0;
    bool EndDependencyErrors() = 0;

    void DisallowedValue() = 0;
    void StartDisallowedType() = 0;
    void AddExpectedType(const typename SchemaType::ValueType& expectedType) = 0;
    void EndDisallowedType(const typename SchemaType::ValueType& actualType) = 0;
    void NotAllOf(ISchemaValidator** subvalidators, SizeType count) = 0;
    void NoneOf(ISchemaValidator** subvalidators, SizeType count) = 0;
    void NotOneOf(ISchemaValidator** subvalidators, SizeType count) = 0;
    void Disallowed() = 0;
};
...
public:
    ...
    ~IGenericRemoteSchemaDocumentProvider() {}
    const SchemaDocumentType* GetRemoteDocument(const Ch* uri, SizeType length) = 0;
};
...
#undef RAPIDJSON_SCHEMA_HANDLE_VALUE_
    ...
    ISchemaValidator* CreateSchemaValidator(const SchemaType& root) {
