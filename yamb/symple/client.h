...
#include "../base/bitwise.h"
#include "../http/websocket.h"
#include "../net/socket.h"
#include "../util/timedmanager.h"
...
public:
    ...
    virtual int sendPresence(const Address& to, const std::string& room, bool probe = false);
    /// Join the given room.
    ...
    Signal<void(Peer&,const json::value&)> PeerConnected;

    /// Signals when a peer disconnects.
    Signal<void(Peer&,const json::value&)> PeerDisconnected;
